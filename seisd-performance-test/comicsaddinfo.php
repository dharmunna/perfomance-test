...
echo "<a href='catagoryinfo.php'>Backhome</a> | <a href='literatureaddinfo.php'>LITERATURE</a> | <a href='nobleaddinfo.php'>NOBLE</a>";
?>
       ...
       //$checkbox1=$_POST['chkhobby'];  
        ...
        //foreach($checkbox1 as $chk1)  
         ...
         //else{
             ...
             //}  
          //}  
          $query1="insert into comicsbook(bookname,writername,publisher,details,price,RegProfile) values('".$_POST["txtbname"]."','".$_POST["txtwname"]."','".$_POST["txtpname"]."','".$_POST["txtfdes"]."','".$_POST["number"]."','".$image."')";
